 ...
 */
@WebServlet("/admin/export/member.csv")
public class ExportMemberServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ExportMemberServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("Mail,Created,Modified");

		for (Member m : list) {
			out.println(m.getExportData());
		}
		out.close();
	}
}
